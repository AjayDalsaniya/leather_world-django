...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('leather_world', '0005_alter_item_item_category_iditem_category_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(db_column='subcategory_idsubcategory', null=True, on_delete=django.db.models.deletion.SET_NULL, to='leather_world.subcategory'),
        ),
    ]
